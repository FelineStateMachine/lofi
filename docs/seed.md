...
| Auth               | **Jazz PasskeyAuth + 24-word passphrase recovery**                    | Jazz custodies the account secret in a resident WebAuthn credential; wrap, don't reinvent. PRF-derived E2E-at-rest is required for account-private fields (#126).                                                                                          |
...
| 5   | **PRF-derived E2E-at-rest** — WebAuthn PRF → HKDF → field-level encryption before data enters Jazz (promoted from stretch to required; scope split in issue #126)                                                                                                                                  | optional | Only if a real threat model demands it; Safari 18 iCloud-Keychain-only; feature-detect, never require                                                                                          |
