...
const lofiImportTargets: Record<string, { subpath: string; localPath: string }> = {
  ...
  "@nzip/lofi/recipes/related-app-discovery": {
    subpath: "recipes/related-app-discovery",
    localPath: "recipes/related-app-discovery.ts",
  },
  "@nzip/lofi/recipes/scope-extension": {
    subpath: "recipes/scope-extension",
    localPath: "recipes/scope-extension.ts",
  },
