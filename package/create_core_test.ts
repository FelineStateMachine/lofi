...
Deno.test("createProject materializes the complete starter snapshot", async () => {
  ...
  try {
    ...
    assertEquals(config.imports["@nzip/lofi"], "jsr:@nzip/lofi@0.5.0");
    assertEquals(config.imports["@nzip/lofi/"], "jsr:@nzip/lofi@0.5.0/");
    assertEquals(config.imports["@nzip/lofi/testing"], "jsr:@nzip/lofi@0.5.0/testing");
    ...
    assert(
      lofiSpecifiers.every((specifier) => specifier.startsWith("jsr:@nzip/lofi@0.5.0/")),
